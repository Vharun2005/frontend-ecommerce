  ...
  return (
   <div>     
    <Container className='shadow-lg p-3 mt-5 mb-5 bg-body-tertiary roundedm mt-4 d-flex justify-content-evenly'>
      <Link className='link color-fa' to='/fashions'>
        <div className=' cursor'>
            ...
            <p className='h6 pt-2 color-fa text-center '>Fashions</p>
        </div>
      </Link>  
        <Link className='link color-fa' to='/electronics'>
          <div className=' cursor '>
              ...
              <p className='color-fa h6 pt-2   space-custom'>Electronics Appliances</p>
          </div>
        </Link>
    </Container>
    <Slider/>
